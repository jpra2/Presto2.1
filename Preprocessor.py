...
configs = sys.argv[1]
configs2 = configparser.RawConfigParser()
configs2.read(configs)
...
class Preprocessor(object):
    ...
    def __init__(self, configs):
        ...
        for i in range(self.numero_de_pocos):
            ...
            localizacao = localizacao.replace(',', '').split()

            localizacao2 = self.poco['localizacao2']
            localizacao2 = localizacao2.replace(',', '').split()
    ...
    def coarse_ratio(self, values):
        ...
        values = np.array(values.split(), dtype='int64')
