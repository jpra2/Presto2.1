...
class MsClassic_mono_faces(MsClassic_mono):
    ...
    def run_faces(self):
        ...
        print('tempo:{0}'.format(tempo_sol_direta))
        ...
        t3 = time.time()
        print('tempo:{0}'.format(t3-t40))

        print('OR')
        self.calculate_restriction_op_2()
        t4 = time.time()
        print('tempo:{0}'.format(t4-t3))
        print('OP')
        tr1 = time.time()
        self.calculate_prolongation_op_het_faces_2()
        t10 = time.time()
        print('Apenas OP:{0}'.format(t10-tr1))
        self.organize_op()
        t5 = time.time()
        print('tempo:{0}'.format(t5-t4))
        print('Sol_mult')
